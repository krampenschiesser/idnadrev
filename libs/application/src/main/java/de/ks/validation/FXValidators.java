...
public class FXValidators {
  ...
  public static Validator<Object> createBeanValidationValidator(Class<?> modelClass, String propertyName) {
    javax.validation.Validator validator = CDI.current().select(javax.validation.Validator.class).get();
    return new BeanValidationValidator(modelClass, validator, propertyName);
  }
}
